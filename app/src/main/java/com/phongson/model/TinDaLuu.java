...
public class TinDaLuu extends TinTuc {
    public TinDaLuu(String idTin, String linkTinTuc, String linkHinhAnh, String tieuDe, Date ngayDang) {
    ...
    public TinDaLuu(String idTin, String linkTinTuc, String linkHinhAnh, String tieuDe, String idLink, Date ngayDang) {
