...
public class AdminAtivity extends AppCompatActivity {
    ...
    Button btnThemChuyenMuc, btnNguon, btnLink, btnCapNhat, btnXoa;
    ...
    private void addEvent() {
        btnCapNhat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                capnhatTinTuc();
                Toast.makeText(AdminAtivity.this, String.valueOf(listLinkTinTuc.size()), Toast.LENGTH_SHORT).show();
                Toast.makeText(AdminAtivity.this, String.valueOf(listNguonTinTuc.size()), Toast.LENGTH_SHORT).show();
            }
        });
...
//                }
                for (int j = 0; j < listNguonTinTuc.size(); j++) {
                    for (int i = 0; i < listLinkTinTuc.size(); i++) {
                        if (listLinkTinTuc.get(i).getIdNguon().equals(listNguonTinTuc.get(j).getIdNguon())) {
                            if (listNguonTinTuc.get(j).getTenNguon().equals("VnExpress")) {
                                new ReadDataVietNamNet().execute(listLinkTinTuc.get(i).getDuongLink());
                            }
//                            if (listNguonTinTuc.get(j).getTenNguon().equals("Thanh Niên")) {
...
//                            }
    ...
    private void addControls() {
        ...
        btnXoa = findViewById(R.id.btnXoaTin);
        // new list
